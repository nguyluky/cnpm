...
import { AnyObject, BusData, PaginatedQuery, PaginationMetaData } from "@src/types/share.type";
import { Formats, IsArray, IsNumber, IsObject, IsString, toSchema } from "@lib/type_declaration";

export class getAllReqBody extends ObjectType {}
export class getAllReqQuery extends PaginatedQuery {}
export class getAllReqParams extends ObjectType {}
